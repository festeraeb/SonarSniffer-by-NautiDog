#!/usr/bin/env python3
"""Scan known project roots for SQLite databases with wreck GPS coordinates."""
import sqlite3
import pathlib
...
roots = [
    here / "db",
    here.parent / "db",
    here.parent / "Bagrecovery" / "db",
]
roots = [r for r in roots if r.exists()]

if not roots:
    print("No DB roots found. Expected one of: ./db, ../db, ../Bagrecovery/db")
    raise SystemExit(1)

print("Scanning DB roots:")
for r in roots:
    print(f"  - {r}")

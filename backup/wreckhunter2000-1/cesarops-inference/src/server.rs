...
fn run_inference(
    ...
    info!("Prompt tokens: {} (real_bpe={}), ids={:?}", prompt_tokens.len(), tokenizer.has_real_vocab, &prompt_tokens[..prompt_tokens.len().min(20)]);
...
pub async fn run_server(
    ...
    let decoder = Arc::new(TransformerDecoder::new(config, arena));

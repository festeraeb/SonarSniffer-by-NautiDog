...
#   bash ~/cesarops-core/wreckhunter2000/scripts/node_update.sh --gpu   # i7/Xeon
#   bash ~/cesarops-core/wreckhunter2000/scripts/node_update.sh --dry-run
#
# NOTE (Pi): Wayfinder runs on the Pi as a test service for low-power nodes.
# This script only touches the wreckhunter repo directory and does NOT affect
# Wayfinder or any other services running on the node.
#

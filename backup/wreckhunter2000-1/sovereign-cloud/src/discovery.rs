...
impl NodeDiscovery {
    ...
    async fn query_tailscale_peers(peers: &Arc<RwLock<HashMap<String, NodeCapabilities>>>) {
        ...
        // i7 RETIRED (2026-05-06) — T440 is primary via Cloudflare tunnel
        let known = [
            (std::env::var("T440_HOST").unwrap_or_else(|_| "10.0.0.61".into()),      8765u16),
            (std::env::var("T440_TAILSCALE").unwrap_or_else(|_| "100.72.182.77".into()), 8765),

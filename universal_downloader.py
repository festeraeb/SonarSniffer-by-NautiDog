...
# (CopernicusDownloader removed — dead 403 API, replaced by
#  AWSSentinel2Downloader / FEDEODownloader. Its orphaned methods, which had
#  leaked into ASFDownloader and shadowed ASFDownloader.run with a Sentinel-2
#  signature, have been deleted.)

//! SonarSniffer Overlays — standalone mosaic feature-alignment CLI
//!
//! A sub-program of the SonarSniffer / CesarOPS infrastructure.
//!
//! Usage:
//!   SonarSniffer Overlays --input path/to/file.RSD [--channel AUTO] [--tiles 5] [--verbose]
...
#[derive(Parser, Debug)]
#[command(
    name = "SonarSniffer Overlays",
    version,
    author = "NautiDog Sailing",
    about = "SonarSniffer Overlays feature-alignment processor for Garmin RSD sonar files"
)]
struct Args {
...
fn main() -> Result<()> {
    ...
    println!("╔══════════════════════════════════════════╗");
    println!("║  SonarSniffer Overlays Feature Alignment Processor  ║");
    println!("╚══════════════════════════════════════════╝");

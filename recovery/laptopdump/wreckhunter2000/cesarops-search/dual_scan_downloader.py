#!/usr/bin/env python3
"""
DATA PROCUREMENT ORDER: THE "CLEAR WATER" DUAL-SCAN
Project: CESARops Basin-Wide "Milling" (Native 64-bit)
...
Two Date Windows:
1. Ice-Break Window (Max Thermal Sink): March 15 - April 30 (2024 & 2025)
2. Low-Silt Window (Max Optical Depth): May 20 - June 15 (2023 & 2024)
"""
...
def execute_dual_scan():
    ...
    print("DATE WINDOWS:")
    print("  1. Ice-Break Window (Max Thermal Sink):")
    for window in ICE_BREAK_WINDOWS:
        print(f"     • {window['start']} to {window['end']}")
    print("    Priority: Landsat-9 B10 (Thermal), B02 (Blue), B11 (SWIR)")
    print()
    print("  2. Low-Silt Window (Max Optical Depth):")
    for window in LOW_SILT_WINDOWS:
        print(f"     • {window['start']} to {window['end']}")
    print("    Priority: Sentinel-2 B01 (Coastal), B02 (Blue), B08 (NIR)")
    print()
    
    print("=" * 120)
    print("EXECUTING DUAL-SCAN...")
    print("=" * 120)
    print()
    ...
    # Step 2: Search Landsat-9 (Ice-Break Window)
    print("[STEP 2/4] SEARCHING LANDSAT-9 (ICE-BREAK WINDOW)...")
    ...
    # Step 3: Search Sentinel-2 (Low-Silt Window)
    print("[STEP 3/4] SEARCHING SENTINEL-2 (LOW-SILT WINDOW)...")
    ...
    # Save tile manifest
    manifest = {
        "scan_type": "Clear Water Dual-Scan",
        "timestamp": datetime.now().isoformat(),
        "bounding_box": LAKE_MICHIGAN_BOUNDS,
        "ice_break_windows": ICE_BREAK_WINDOWS,
        "low_silt_windows": LOW_SILT_WINDOWS,
        "total_tiles": total_tiles,
        "landsat_9_count": len(high_quality_landsat),
        "sentinel_2_count": len(high_quality_sentinel),

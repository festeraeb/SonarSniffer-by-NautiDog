"""
VERIFIED TOP 10 TARGETS - KML GENERATOR

Uses ONLY the verified coordinates from the multi-sensor analysis document.
These are the CORRECT coordinates that show the Andaste and other lake targets.
"""
...
# ── VERIFIED COORDINATES FROM MULTI-SENSOR ANALYSIS ──────────────────────────
...
VERIFIED_TARGETS = [
    {
        ...
        'depth_m': 150,
        'confidence_stars': 5,
        'sensor_hits': 'B02: 1.14 (STRONG), B04: 1.23 (STRONGEST), B01: 0.48 (Moderate)',
    ...
    },
    {
        ...
        'depth_m': 120,
        'confidence_stars': 5,
        'sensor_hits': 'B02: 1.06 (Strong), B04: 1.14 (Very Strong), B01: 0.52 (Moderate)',
    ...
    },
    {
        ...
        'depth_m': 160,
        'confidence_stars': 4,
        'sensor_hits': 'B02: 0.99 (Good), B04: 1.02 (Strong), B01: Weak',
    ...
    },
    {
        ...
        'depth_m': 140,
        'confidence_stars': 4,
        'sensor_hits': 'B02: 0.94 (Good), B04: 0.91 (Good), B01: 0.50 (Moderate)',
    ...
    },
    {
        ...
        'depth_m': 155,
        'confidence_stars': 4,
        'sensor_hits': 'B02: 0.95 (Good), B04: 0.88 (Good), B01: Weak',
    ...
    },
    {
        ...
        'depth_m': 175,
        'confidence_stars': 3,
        'sensor_hits': 'B02: 0.88 (Fair), B04: 0.85 (Fair), B01: No hit',
    ...
    },
    {
        ...
        'depth_m': 145,
        'confidence_stars': 4,
        'sensor_hits': 'B02: 0.94 (Good), B04: 0.91 (Good), B01: 0.48 (Moderate)',
    ...
    },
    {
        ...
        'depth_m': 130,
        'confidence_stars': 3,
        'sensor_hits': 'B02: 0.88 (Fair), B04: 0.85 (Fair), B01: Weak',
    ...
    },
    {
        ...
        'depth_m': 165,
        'confidence_stars': 3,
        'sensor_hits': 'B02: 0.85 (Fair), B04: 0.82 (Fair), B01: No hit',
    ...
    },
    {
        ...
        'depth_m': 110,
        'confidence_stars': 3,
        'sensor_hits': 'B02: 0.85 (Fair), B04: 0.81 (Fair), B01: Weak',
...
def create_kml():
    """Create KML content with verified targets."""
    
    kml = '''<?xml version="1.0" encoding="UTF-8"?>
<kml xmlns="http://www.opengis.net/kml/2.2">
  <Document>
    <name>VERIFIED Top 10 Lake Michigan Targets</name>
    <description>
      <![CDATA[
      <h1>WreckHunter2000 - VERIFIED Top 10 Targets</h1>
      ...
      <p><b>NOTE:</b> These are VERIFIED coordinates in Lake Michigan (not on land).</p>
    ...
    <Placemark>
      ...
      <description>
        ...
        <table>
          ...
          <tr><td><b>Sensor Hits:</b></td><td>{target["sensor_hits"]}</td></tr>
...
if __name__ == '__main__':
    print('='*80)
    print('VERIFIED TOP 10 LAKE MICHIGAN TARGETS - KML GENERATOR')
    print('='*80)
    print()
    ...
    # Save KML
    kml_path = Path('c:/Users/thomf/programming/wreckhunter2000/outputs/VERIFIED_top_10_targets.kml')
    with open(kml_path, 'w', encoding='utf-8') as f:
        f.write(kml_content)
    
    print(f'KML saved: {kml_path}')
    print()
    print('VERIFIED TOP 10 TARGETS (In Lake Michigan - NOT on land):')
    for target in VERIFIED_TARGETS:
        andaste_note = ' (Andaste)' if target['rank'] in [1, 4] else ''
        print(f'  #{target["rank"]}: {target["name"][:40]}{andaste_note} - {target["confidence_stars"]}⭐')

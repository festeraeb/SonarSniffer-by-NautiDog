...
///
/// The geo_transform is sourced from the VRT XML or mission spec — NOT from TIFF
/// metadata tags, which are absent or unreliable for Sentinel SAR and some Landsat
/// scenes.  Callers must inject the correct transform from the VRT/mission data path.
#[derive(Clone, Copy)]
